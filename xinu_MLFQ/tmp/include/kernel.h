...
extern	qid16	user_list_high;	/* global ID for list of highest priority user processes*/
extern	qid16	user_list_med;	/* global ID for list of meduium priority user processes*/
extern	qid16	user_list_low;	/* global ID for list of lowest priority user processes*/
